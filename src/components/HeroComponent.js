    ...
    render() {
        return (
            <div class="min-h-screen">
                <div className="hero min-h-screen bg-light lg:bg-fixed" style={{ backgroundImage: `url(./images/neko.jpg)` }}>
